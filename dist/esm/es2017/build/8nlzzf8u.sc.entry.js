...
import { h } from '../agc-rye-production-cost.core.js';

import { a as validate, b as round, c as mapEnterKey } from './chunk-20c43398.js';

class AgcRyeProductionCost {
    constructor() {
        this.socket = "";
        this.tract = "";
        this.mode = "step";
        this.units = { land: "acre", yield: "bu/acre", rye: "bu" };
        this.currentStep = 0;
        this.cache = {};
    ...
    render() {
        return (h("div", null,
            h("form", { onSubmit: e => e.preventDefault(), ref: c => (this.form = c), "data-wizard": "agc-rye-production-cost", "data-wizard-mode": this.mode, class: "agc-wizard" },
                h("slot", null),
                h("section", { "data-wizard-section": "0" },
                    h("div", { class: "agc-wizard__field" },
                        ...
                        h("p", { "data-i18n": `hints.market-price.${this.units["rye"]}` }, "\u2BA4 Enter the expected market price for rye per bushel.")),
    ...
    static get is() { return "agc-rye-production-cost"; }
