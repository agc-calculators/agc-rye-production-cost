...
class AgcRyeProductionCostResultsPlaceholder {
    render() {
    ...
    static get is() { return "agc-rye-production-cost-results-placeholder"; }
}

export { AgcRyeProductionCostResultsPlaceholder };
