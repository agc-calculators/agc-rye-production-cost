...
@Component({
  tag: "agc-rye-production-cost"
})
export class AgcRyeProductionCost {
  @Prop() socket: string = "";
  @Prop() tract: string = "";
  @Prop() mode: "full" | "step" = "step";
  @Prop() units: any = { land: "acre", yield: "bu/acre", rye: "bu" };
  @State() currentStep = 0;
  @State() cache = {};
    ...
    return (
      <div>
        <form
          ...
          data-wizard="agc-rye-production-cost"
        ...
        >
          ...
          <section data-wizard-section="0">
            <div class="agc-wizard__field">
              ...
              <p data-i18n={`hints.market-price.${this.units["rye"]}`}>
                ⮤ Enter the expected market price for rye per bushel.
              </p>
            </div>
